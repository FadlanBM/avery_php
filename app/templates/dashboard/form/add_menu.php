                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                ...
                                <div class="space-y-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <input name="price" class="w-full bg-surface-container-high border-none rounded-xl pl-12 pr-4 py-3 text-on-surface shadow-sm focus:ring-1 focus:ring-primary focus:bg-white transition-all" placeholder="0" type="number" required />
                                    </div>
                                </div>
                                <div class="space-y-2">
                                    <label class="block text-sm font-bold text-orange-900 font-headline ml-1">Stok Awal</label>
                                    <input name="stock" class="w-full bg-surface-container-high border-none rounded-xl px-4 py-3 text-on-surface shadow-sm focus:ring-1 focus:ring-primary focus:bg-white transition-all" placeholder="0" type="number" min="0" required />
                                </div>
                                <div class="md:col-span-2">
